  ...
  const timeSavings = [
    {
      icon: Clock,
      value: '140 ore',
      description: 'economisite pe an',
      color: 'text-emerald-600',
    },
    {
      icon: Dumbbell,
      value: '100 intrări',
      description: 'la sală în timpul economisit',
      color: 'text-violet-600',
    },
    {
      icon: Plane,
      value: '6 weekend-uri',
      description: 'prelungite câștigate',
      color: 'text-cyan-600',
    },
    {
      icon: Users,
      value: '100 ieșiri',
      description: 'în parc cu familia',
      ...
      <div className="container mx-auto px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-violet-600 text-white rounded-full mb-6">
            ...
            <span className="text-sm font-medium">Beneficii</span>
          </div>
          <h2 className="text-5xl font-bold mb-4 text-gray-900">
            Ce Câștigi Cu CoolBOX?
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Timp prețios pentru lucrurile care contează cu adevărat
          </p>
        </motion.div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Alimente proaspete de la producători și retaileri locali, menținute la temperatura optimă.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-l-4 border-violet-500">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Ridică cumpărăturile în câteva secunde, exact când îți convine, fără cozi sau trafic.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-l-4 border-cyan-500">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Elimină stresul planificării, traficului și cozilor. Mai mult timp pentru ce iubești.
                  </p>
                </div>
              </div>
            </div>
